...
INSERT INTO mission_object (id, name, kr, icon, is_active, mission_id) VALUES (4, 'motorcycle', '오토바이', '?', 1, 2);
...
INSERT INTO mission_object (id, name, kr, icon, is_active, mission_id) VALUES (8, 'boat', '보트', '?', 1, 2);
...
INSERT INTO mission_object (id, name, kr, icon, is_active, mission_id) VALUES (20, 'skis', '스키', '⛷️', 1, 2);
INSERT INTO mission_object (id, name, kr, icon, is_active, mission_id) VALUES (21, 'surfboard', '서핑보드', '?', 1, 2);
INSERT INTO mission_object (id, name, kr, icon, is_active, mission_id) VALUES (22, 'snowboard', '스노보드', '?', 1, 2);
INSERT INTO mission_object (id, name, kr, icon, is_active, mission_id) VALUES (23, 'sports ball', '스포츠 볼', '⚽', 1, 2);
...
INSERT INTO mission_object (id, name, kr, icon, is_active, mission_id) VALUES (30, 'cup', '컵', '☕', 1, 2);
...
INSERT INTO mission_object (id, name, kr, icon, is_active, mission_id) VALUES (46, 'couch', '소파', '?', 1, 2);
INSERT INTO mission_object (id, name, kr, icon, is_active, mission_id) VALUES (47, 'potted plant', '화분', '?', 1, 2);
INSERT INTO mission_object (id, name, kr, icon, is_active, mission_id) VALUES (48, 'bed', '침대', '?', 1, 2);
...
INSERT INTO mission_object (id, name, kr, icon, is_active, mission_id) VALUES (51, 'mouse', '마우스', '?', 1, 2);
...
INSERT INTO mission_object (id, name, kr, icon, is_active, mission_id) VALUES (62, 'hair drier', '헤어 드라이어', '?', 1, 2);
