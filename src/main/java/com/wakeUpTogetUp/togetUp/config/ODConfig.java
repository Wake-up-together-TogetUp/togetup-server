...
public class ODConfig {
    ...
    private final List<String> names = new ArrayList<>(Arrays.asList(
            ...
            "train", "boat", "traffic light", "bird", "cat", "dog",
            "horse", "backpack", "umbrella", "handbag", "tie", "suitcase",
            "frisbee", "skis", "surfboard", "snowboard", "sports ball",
            "baseball bat", "baseball glove", "skateboard", "tennis racket",
            "bottle", "wine glass", "cup", "fork", "knife", "spoon", "bowl",
            "banana", "apple", "sandwich", "orange", "broccoli", "carrot",
            "hot dog", "pizza", "donut", "cake", "chair", "couch",
            "potted plant", "bed", "tv", "laptop", "mouse", "keyboard",
            "cell phone", "oven", "toaster", "refrigerator", "book", "clock",
