...
public class RoomInviteInfoRes {
	...
	@Schema(description = "미션 이름(영어)", example = "car")
	private String missionName;

	public static RoomInviteInfoRes of(Integer id, String icon, String name, String intro, Timestamp createdAt,
		Integer headCount, Integer missionObjectId, String missionKr, String missionName) {
		return new RoomInviteInfoRes(id, icon, name, intro, createdAt.toLocalDateTime().toLocalDate(), headCount,
			missionObjectId, missionKr, missionName);
	}
}
